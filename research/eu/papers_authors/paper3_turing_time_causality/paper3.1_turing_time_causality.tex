...
\end{equation}
O treinamento foi executado por $20.000$ épocas em GPU (NVIDIA RTX 3050, tempo total de $19{,}49$\,min). A verdade terrestre de referência (\textit{ground truth}) foi gerada pelo resolvedor MDF ADI linearizado de \textcite{pereira2019} em malha de $128 \times 128$ nós com $\Delta t = 10^{-3}\,\text{s}$.
...
\centering
\includegraphics[width=0.74\textwidth]{figures/fig_loss_heterogeneity_duo.pdf}\\
...
\centering
\includegraphics[width=0.74\textwidth]{figures/fig_combined_snapshots_profile.pdf}\\
{\footnotesize Fonte: Elaboração própria.}
\end{figure}
