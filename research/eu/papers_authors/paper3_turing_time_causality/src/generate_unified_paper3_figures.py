...
fig = plt.figure(figsize=(7.0, 4.2), dpi=300)
...
ax1.set_title(r'(a) Dinâmica de Convergência das Perdas', fontsize=7.2, pad=2)
...
ax2.set_title(r'(b) Heterogeneidade Temporal', fontsize=7.2, pad=2)
...
fig = plt.figure(figsize=(7.0, 4.95), dpi=300)
